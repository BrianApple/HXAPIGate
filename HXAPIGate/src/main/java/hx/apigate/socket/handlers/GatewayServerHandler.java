...
public class GatewayServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, final FullHttpRequest msg) {
         ...
         if(ret[1] != null && ret[1] instanceof RouteNode){
        	 ...
        	 ctx.writeAndFlush(MixAll.getDefaultFullHttpResponse(1111, "The path you accessed does not exist !"));
         }
    }
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		System.out.println("web channel active");
	}

	@Override
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		super.channelInactive(ctx);
		System.out.println("web channel destory");
		ctx.deregister();
	}
