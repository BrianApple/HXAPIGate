...
import hx.apigate.databridge.Route;
import hx.apigate.databridge.RouteAll;
...
public class ReloadXmlAware implements IProcessor{
	...
	public void start() throws Exception {
		...
		logger.info("==============================================================================================");
		logger.info("==============================================================================================");
		logger.info("ooooo   ooooo       .o.        .oooooo.     ooooooo  ooooo ooooo ooooo      ooo ");
		logger.info("`888'   `888'      .888.      d8P'  `Y8b     `8888    d8'  `888' `888b.     `8'        A");
		logger.info(" 888     888      .8\"888     888      888      Y888..8P     888   8 `88b.    8         ");
		logger.info(" 888ooooo888     .8' `888.   888      888       `8888'      888   8   `88b.  8         P");
		logger.info(" 888     888    .88ooo8888.  888      888      .8PY888.     888   8     `88b.8          ");
		logger.info(" 888     888   .8'     `888. `88b    d88'     d8'  `888b    888   8       `888         I");
		logger.info("o888o   o888o o88o     o8888o `Y8bood8P'    o888o  o88888o o888o o8o        `8");
		logger.info("=============================================================================================");
